...
$paginas_permitidas = [
    ...
    'autor/Autor' => 'View/autor/autor.php',
    'autor/listarAutores' => 'View/autor/listarAutores_partial.php',
    
    'noticia/Noticia' => 'View/noticia/noticia.php',
    'noticia/listarNoticias' => 'View/noticia/listarNoticias_partial.php',
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'autor/listarAutores' ? 'active' : '' ?>" href="paginas?page=autor/listarAutores">Autores</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'noticia/listarNoticias' ? 'active' : '' ?>" href="paginas?page=noticia/listarNoticias">Noticia</a>
                    </li>
